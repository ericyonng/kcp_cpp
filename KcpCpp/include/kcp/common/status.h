...
#ifndef __KCP_CPP_KCP_CPP_INCLUDE_KCP_COMMON_STATUS_H__
#define __KCP_CPP_KCP_CPP_INCLUDE_KCP_COMMON_STATUS_H__
...
namespace Status
{
    enum StatusEnum :Int32
    {
        ...
        #pragma region Engine[5000, 5999]
        Engine_SessionOverLimit = 5000,                         // 会话数量过多
        #pragma endregion

        #pragma region Poller[6000, 6999]
